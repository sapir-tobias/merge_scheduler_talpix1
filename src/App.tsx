...
import { DegreeProvider, useDegree } from './state/DegreeContext'
import Tooltip from './components/Tooltip'
import { Download, Upload, Ban, BookOpen } from 'lucide-react'
import type { SemesterId, PlanYear, DayKey } from './types'
import { buildPlan, type TrackId } from './data/plans'
...
function Inner() {
  ...
  function handleLoadPlan(track: TrackId) {
    const placed = buildPlan(track, state.exemptions)
