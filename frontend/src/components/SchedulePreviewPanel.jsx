...
function buildSlots(choices, courseMap) {
  const slots = []
...
function countCollisions(choices, blockers, courseMap) {
...
function getAllConfigs(placed, blockers, courseMap) {
  let combos = [[]]
...
function MiniSchedule({ choices, collisions, blockers, courseMap }) {
  const slots = buildSlots(choices, courseMap)
