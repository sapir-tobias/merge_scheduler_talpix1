...
function makeInitialState(initialPlaced: PlacedCourse[]): DegreeState {
  return {
...
export function DegreeProvider({ children, initialPlaced }: { children: ReactNode; initialPlaced: PlacedCourse[] }) {
